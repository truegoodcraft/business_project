...
from core.api.routes.logs_api import public_router as logs_public_router, router as logs_router
...
def create_app():
    ...
    if not getattr(app.state, "_domain_routes_registered", False):
        ...
        app.include_router(logs_public_router, prefix="/app")
        app.include_router(logs_router, prefix="/app")
