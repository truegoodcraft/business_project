...
$bulkStatus = ($bulkTry.ok) ? 200 : $bulkTry.err.Exception.Response.StatusCode.value__
...
$emptyStatus = ($emptyComp.ok) ? 200 : $emptyComp.err.Exception.Response.StatusCode.value__
